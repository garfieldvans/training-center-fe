...
import { trainingMenus } from "../../../../utils/data";
...
const Header = () => {
  ...
  return (
    <div>
      <div className=" fixed top-0 w-full flex flex-row items-center justify-between py-4 md:py-5 bg-bg-external h-16 md:h-16 md:pl-20 md:pr-10 ">
        <span className="text-gray-100 capitalize font-bold text-xl md:text-2xl">
          {displayPath}
        </span>
        <div className=" flex flex-row gap-10 items-center bg-white rounded-xl px-6 py-1">
          <div className="bg-slate-200 p-2 rounded-lg">
            <button type="button" className="flex flex-row items-center">
              <FaRegBell size={20} />
            </button>
          </div>
          <div className="flex text-sm font- flex-row gap-3 items-center">
